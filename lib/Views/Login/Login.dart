...
import 'package:idlebusiness_mobile/Views/Login/Register.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void validateAndSubmit() async {
    ...
    if (validateAndSave()) {
      var success = await Auth().signIn(_email, _password);
      if (success) {
        Navigator.push(
            context,
            MaterialPageRoute(
  ...
  void createGuest() async {
    ...
    var success = await Auth().createGuestAccount();
    if (success) {
      Navigator.push(
          context,
          MaterialPageRoute(
